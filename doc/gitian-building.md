...
*Setup instructions for a Gitian build of SuperAlki Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the SuperAlki
...
- [Building SuperAlki Core](#building-superalki-core)
...
To build SuperAlki Core (for Linux, OS X and Windows) just follow the steps under 'perform
