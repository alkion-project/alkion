UNIX BUILD NOTES
====================
Some notes on how to build SuperAlki Core in Unix.
...
memory available when compiling SuperAlki Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build SuperAlki Core without wallet.
...
If you want to build SuperAlki-Qt, make sure that the required packages for Qt development
...
# Configure SuperAlki Core to use our own-built instance of BDB
cd $SUPERALKI_ROOT
./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard SuperAlki Core distributions and independently built
...
with 4.8-built SuperAlki Core is needed follow the steps under "Berkeley DB" above.
