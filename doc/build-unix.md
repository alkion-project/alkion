UNIX BUILD NOTES
====================
Some notes on how to build Alkion Core in Unix.
...
memory available when compiling Alkion Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Alkion Core without wallet.
...
If you want to build Alkion-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Alkion Core distributions and independently built
...
with 4.8-built Alkion Core is needed follow the steps under "Berkeley DB" above.
